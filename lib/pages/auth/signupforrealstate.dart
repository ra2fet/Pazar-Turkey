...
class SignUpRealState extends StatefulWidget {

  final RealStateModel realStateItem;
  final totalPrice, rdays;
  final pickupdate, dropoffdate;

  const SignUpRealState({Key key, this.realStateItem, this.totalPrice, this.rdays, this.pickupdate, this.dropoffdate}) : super(key: key);

  @override
  _SignUpRealStateState createState() => _SignUpRealStateState();
}

class _SignUpRealStateState extends State<SignUpRealState> {
...
if(fullNameController.text.isNotEmpty && emailController.text.isNotEmpty && phoneNumberController.text.isNotEmpty || passportNumberController.text.isNotEmpty  ||
 ...
 _nationalityController.text.isNotEmpty || _birthdayDateController.text.isNotEmpty){
    ...
    Requests.reserveRealState(fullNameController.text, emailController.text, phoneNumberController.text, passportNumberController.text
    , mynationalityselection, _birthdayDateController.text, widget.rdays, widget.totalPrice,widget.realStateItem.subtitle,widget.realStateItem.title,widget.pickupdate,widget.dropoffdate);

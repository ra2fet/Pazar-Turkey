...
class ServicesComments extends StatefulWidget {
  final int postid;
  final bool ismenu;

  const ServicesComments({Key key, @required this.postid, this.ismenu})
      : super(key: key);

  @override
  _ServicesCommentsState createState() => _ServicesCommentsState();
}

class _ServicesCommentsState extends State<ServicesComments> {
  ...
  void initState() {
    ...
    Requests.getServiceComments(widget.postid, widget.ismenu).then((value) {
      setState(() {
        comList = value;
        loading = false;
      });
  ...
  void sendComment(rating) {
    if (commentController.text.isEmpty) {
      ...
      Requests.addComments(
          widget.ismenu
              ? "api/service_types_comments/addnew"
              : "api/service_comments/addnew",
          rating,

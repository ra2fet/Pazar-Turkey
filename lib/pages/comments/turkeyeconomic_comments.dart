...
class TurkeyEconomicComments extends StatefulWidget {
  final int postid;

  const TurkeyEconomicComments({Key key, @required this.postid})
      : super(key: key);

  @override
  _TurkeyEconomicCommentsState createState() => _TurkeyEconomicCommentsState();
}

class _TurkeyEconomicCommentsState extends State<TurkeyEconomicComments> {
  ...
  void initState() {
    ...
    print(widget.postid);
    Requests.getTurkeyEconomicComments(widget.postid).then((value) {
      setState(() {
        comList = value;
        loading = false;
      });
  ...
  void sendComment(rating) {
    if (commentController.text.isEmpty) {
      ...
      Requests.addComments("api/turkey_economic_comments/addnew", rating,

...
PrayModel prayModelFromJson(String str) => PrayModel.fromJson(json.decode(str));

String prayModelToJson(PrayModel data) => json.encode(data.toJson());
